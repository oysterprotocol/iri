...
public class APIIntegrationTests {
     ...
     * curl http://localhost:14265 \
     -X POST \
     -H 'Content-Type: application/json' \
     -d '{"command": "getBulkTransactionsToApprove", "depth": 3, "quantity": 10}'
     */
    @Test
    public void shouldTestGetBulkTransactionsToApprove() {

        final Map<String, Object> request = new HashMap<>();
        request.put("command", "getBulkTransactionsToApprove");
        request.put("depth", 3);
